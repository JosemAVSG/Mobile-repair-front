...
const ESTADO_TRANSITIONS: Record<EstadoOrden, EstadoOrden[]> = {
  ...
  [EstadoOrden.REPARACION]: [EstadoOrden.ESPERANDO_REPUESTO, EstadoOrden.REPARACION_COMPLETADA, EstadoOrden.DIAGNOSTICO],
...
const TRANSITION_LABELS: Record<string, string> = {
  ...
  'REPARACION:DIAGNOSTICO': 'Volver a Diagnosticar',
...
> = {
  ...
  'REPARACION:DIAGNOSTICO': 'secondary',
